...
// Category - enum возможных категорий компонента
type Category int32
...
// GetHardwareRequest предоставляет запрос на получение компонента по UUID
...
// GetHardwareResponse предоставляет ответ на получение компонентов по UUID
...
// Hardware это структура описание компонента
...
// ListHardwaresRequest представляет запрос на получение списка компонентов по фильтрам.
...
// ListHardwaresResponse представляет ответ на получение списка компонентов по фильтрам.
...
// PartsFilter - возможные фильтры для получения списка компонентов
