...
const (
	PaymentMethod_PAYMENT_METHOD_UNDEFINED PaymentMethod = 0
	PaymentMethod_PAYMENT_METHOD_SASH      PaymentMethod = 1
...
var (
	PaymentMethod_name = map[int32]string{
		0: "PAYMENT_METHOD_UNDEFINED",
		1: "PAYMENT_METHOD_SASH",
		2: "PAYMENT_METHOD_CARD",
		3: "PAYMENT_METHOD_SBP",
	}
	PaymentMethod_value = map[string]int32{
		"PAYMENT_METHOD_UNDEFINED": 0,
		"PAYMENT_METHOD_SASH":      1,
...
func (x *PayOrderRequest) GetPaymentMethod() PaymentMethod {
	...
	return PaymentMethod_PAYMENT_METHOD_UNDEFINED
}
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"payment.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"r\n" +
	"\x0fPayOrderRequest\x12\x1d\n" +
	"\n" +
	"order_uuid\x18\x01 \x01(\tR\torderUuid\x12@\n" +
	"\x0epayment_method\x18\x02 \x01(\x0e2\x19.payment.v1.PaymentMethodR\rpaymentMethod\"x\n" +
	...
	"\x12PAYMENT_METHOD_SBP\x10\x032W\n" +
	"\x0ePaymentService\x12E\n" +
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseBQZOgithub.com/azoma13/computer-assembly-service/shared/proto/payment/v1;payment_v1b\x06proto3"
