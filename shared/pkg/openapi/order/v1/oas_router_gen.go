				...
				case '/': // Prefix: "/"
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "POST":
								s.handlePaymentOrderRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "POST")
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.pathPattern = "/order/{order_uuid}"
						r.args = args
						r.count = 1
						return r, true
					default:
				...
				case '/': // Prefix: "/"
					...
					case 'c': // Prefix: "cancel"
						...
						if len(elem) == 0 {
							...
							case "POST":
								...
								r.pathPattern = "/order/{order_uuid}/cancel"
								r.args = args
								r.count = 1
								return r, true
							default:
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "POST":
								r.name = PaymentOrderOperation
								r.summary = "Paid order by UUID"
								r.operationID = "paymentOrder"
								r.pathPattern = "/order/{order_uuid}/pay"
								r.args = args
								r.count = 1
								return r, true
							default:
